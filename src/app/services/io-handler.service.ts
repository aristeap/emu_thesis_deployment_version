...
class IoHandlerService{
	...
	*/
	public getDBconfigFile(nameOfDB) {
		// console.log("INSIDE io-handler.service.ts------->getDBconfigFile(nameOfDB)");
		...
		if (this.ConfigProviderService.vals.main.comMode === 'CORS') {
			...
			console.log("inside ConfigProviderService.vals.main.comMode === 'DEMO'");
			getProm = this.$http.get('demoDBs/' + nameOfDB + '/' + nameOfDB + '_DBconfig.json');
			console.log("demoDBs/" + nameOfDB + "/" + nameOfDB + "_DBconfig.json");
		} else if (this.ConfigProviderService.vals.main.comMode === 'GITLAB'){
			console.log("inside ConfigProviderService.vals.main.comMode === 'GITLAB'");
			var searchObject = this.$location.search();
	...
	*/
	public getBundleList(nameOfDB) {
		// console.log("INSIDE io-handler.service.ts------->getBundleList(nameOfDB)");
		console.log("nameOfDB: ",nameOfDB);
		var getProm;
		...
		if (this.ConfigProviderService.vals.main.comMode === 'CORS') {
			...
			console.log("demoDBs/" + nameOfDB + "/" + nameOfDB + "_bundleList.json");
	...
	public getBundle(name, session, nameOfDB, gridFSRef) {
	 ...
	 console.log("nameOfDB: ",nameOfDB);
		...
		if (this.ConfigProviderService.vals.main.comMode === 'CORS') {
			...
			console.log("demoDBs/" + nameOfDB + "/" + name + "_bndl.json");
			//console.log("getProm: ",getProm);
		} else if (this.ConfigProviderService.vals.main.comMode === 'GITLAB') {
			console.log("ConfigProviderService.vals.main.comMode === 'GITLAB");
			...
			if(searchObject.useLFS !== "true"){
				console.log("searchObject.useLFS---------------------------------------");
				getProm = Promise.all([
				...
				console.log("data(meaning the wav file): ", bndlURL + name + '.wav/raw?ref=master');	
			} else {
