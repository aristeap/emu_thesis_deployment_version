 ...
 * Javascript code in this page
 */
// console.log("Inside the pdf.min.js assets");
        ...
        function (module, exports, __w_pdfjs_require__) {
                    ...
                    .then(function () {
                        ...
                        const e = _fetchDocument(a, n, s, i),
                            r = new Promise(function (e) {
                                let t;
                                s
                                    ? (t = new _transport_stream.PDFDataTransportStream({ length: n.length, initialData: n.initialData, progressiveDone: n.progressiveDone, disableRange: n.disableRange, disableStream: n.disableStream }, s))
                                    : n.data ||
            ...
            class PDFPageProxy {
                ...
                render({
                    ...
                    if (!u.displayReadyCapability) {
                        ...
                        this._pumpOperatorList({ pageIndex: this._pageIndex, intent: d, renderInteractiveForms: !0 === s, annotationStorage: (c && c.getAll()) || null });
                    }
                    const complete = (e) => {
                ...
                streamTextContent({ normalizeWhitespace: e = !1, disableCombineTextItems: t = !1 } = {}) {
                    return this._transport.messageHandler.sendWithStream("GetTextContent", { pageIndex: this._pageIndex, normalizeWhitespace: !0 === e, combineTextItems: !0 !== t }, { highWaterMark: 100, size: (e) => e.items.length });
                }
                getTextContent(e = {}) {
            ...
            class WorkerTransport {
                constructor(e, t, r, n) {
                    ...
                    this.fontLoader = new _font_loader.FontLoader({ docId: t.docId, onUnsupportedFeature: this._onUnsupportedFeature.bind(this), ownerDocument: n.ownerDocument });
                    this._params = n;
                ...
                saveDocument(e) {
                    return this.messageHandler.sendWithPromise("SaveDocument", { numPages: this._numPages, annotationStorage: (e && e.getAll()) || null, filename: this._fullReader ? this._fullReader.filename : null }).finally(() => {
                        e && e.resetModified();
                    });
                }
                getDestinations() {
                ...
                getMetadata() {
                    return this.messageHandler
                        ...
                        .then((e) => ({ info: e[0], metadata: e[1] ? new _metadata.Metadata(e[1]) : null, contentDispositionFilename: this._fullReader ? this._fullReader.filename : null }));
                }
                getStats() {
                ...
                o = (function CanvasGraphicsClosure() {
                    ...
                    CanvasGraphics.prototype = {
                        ...
                        paintChar(e, t, r, s) {
                            ...
                            if (d) {
                                (this.pendingTextPaths || (this.pendingTextPaths = [])).push({ transform: a.mozCurrentTransform, x: t, y: r, fontSize: c, addToPath: p });
                            }
                        },
                        ...
                        paintImageXObjectRepeat: function CanvasGraphics_paintImageXObjectRepeat(e, t, r, s) {
                            ...
                            if (a) {
                                for (var i = a.width, o = a.height, l = [], c = 0, h = s.length; c < h; c += 2) l.push({ transform: [t, 0, 0, r, s[c], s[c + 1]], x: 0, y: 0, w: i, h: o });
        ...
        function (e, t, r) {
            ...
            t.MessageHandler = class MessageHandler {
                ...
                async _deleteStreamController(e) {
                    // 1. Gather the three calls
                    const calls = [
                      this.streamControllers[e].startCall,
                      this.streamControllers[e].pullCall,
                      this.streamControllers[e].cancelCall
                    ].map(c => c && c.promise).filter(Boolean);
                  
                    // 2. For each promise, transform it so it never rejects
                    //    Instead, it resolves to an object { status, valueOrReason }.
                    const wrappedCalls = calls.map(p => {
                      return p.then(
                    ...
                    // 3. Wait for all of them. This never throws because we catch rejections.
                    const results = await Promise.all(wrappedCalls);
                    // You could log or handle results if you like:
                    // console.log("_deleteStreamController results:", results);
                  
                    // 4. Finally, remove the stream controller.
        ...
        function (e, t, r) {
            ...
            class AnnotationElement {
                ...
                _createPopup(e, t, r) {
                    ...
                    const n = new PopupElement({ container: e, trigger: t, color: r.color, title: r.title, modificationDate: r.modificationDate, contents: r.contents, hideWrapper: !0 }).render();
            ...
            class LinkAnnotationElement extends AnnotationElement {
                ...
                render() {
                    ...
                    e.url
                        ? (0, n.addLinkAttributes)(r, { url: e.url, target: e.newWindow ? n.LinkTarget.BLANK : t.externalLinkTarget, rel: t.externalLinkRel, enabled: t.externalLinkEnabled })
                        : e.action
            ...
            class PopupAnnotationElement extends AnnotationElement {
                ...
                render() {
                    ...
                    const r = new PopupElement({ container: this.container, trigger: t, color: this.data.color, title: this.data.title, modificationDate: this.data.modificationDate, contents: this.data.contents }),
            ...
            class FileAttachmentAnnotationElement extends AnnotationElement {
                constructor(e) {
                    ...
                    this.content = r;
                    this.linkService.eventBus && this.linkService.eventBus.dispatch("fileattachmentannotation", { source: this, id: (0, s.stringToPDFString)(t), filename: t, content: r });
                }
                render() {
                ...
                s = (function renderTextLayerClosure() {
                    ...
                    function appendText(t, r, s) {
                        var a = document.createElement("span"),
                            i = { angle: 0, canvasWidth: 0, isWhitespace: !1, originalTransform: null, paddingBottom: 0, paddingLeft: 0, paddingRight: 0, paddingTop: 0, scale: 1 };
                        t._textDivs.push(a);
                        if (
